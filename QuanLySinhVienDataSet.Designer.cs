...
namespace DoNguyenAnhTuan117000682 {
    ...
    public partial class QuanLySinhVienDataSet : global::System.Data.DataSet {
        ...
        public partial class tblStudentDataTable : global::System.Data.TypedTableBase<tblStudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public tblStudentRow AddtblStudentRow(string StudentName, int ClassID) {
...
namespace DoNguyenAnhTuan117000682.QuanLySinhVienDataSetTableAdapters {
    ...
    public partial class tblStudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblStudent] WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_ClassID = 1 AND [ClassID] IS NULL) OR ([ClassID] = @Original_ClassID)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblStudent] ([StudentName], [ClassID]) VALUES (@StudentName, @" +
                "ClassID);\r\nSELECT StudentID, StudentName, ClassID FROM tblStudent WHERE (Student" +
                "ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblStudent] SET [StudentName] = @StudentName, [ClassID] = @ClassID WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_ClassID = 1 AND [ClassID] IS NULL) OR ([ClassID] = @Original_ClassID)));
SELECT StudentID, StudentName, ClassID FROM tblStudent WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DoNguyenAnhTuan117000682.Properties.Settings.Default.QuanLySinhVienConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, StudentName, ClassID FROM dbo.tblStudent";
        ...
        public virtual int Fill(QuanLySinhVienDataSet.tblStudentDataTable dataTable) {
        ...
        public virtual QuanLySinhVienDataSet.tblStudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLySinhVienDataSet.tblStudentDataTable dataTable = new QuanLySinhVienDataSet.tblStudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLySinhVienDataSet.tblStudentDataTable dataTable) {
